...
const Chainprizes: NextPage = () => {
  return (
    <div className="container mx-auto min-h-screen flex flex-col align-items-center justify-center space-y-2 px-5">
      ...
      <DashSection
        ...
        dropdown={<Dropdown items={exampleDropdownItems} />}
      >
        <DonutChart distPercent={25} salePercent={35} returnPercent={20} />
      </DashSection>
      <DashSection
        title="Reports"
        headingLevel="h2"
